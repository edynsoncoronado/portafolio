    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold text-red-600 mb-4">IRON FIT</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Cardio Blast</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Yoga & Flexibility</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">HIIT Challenge</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} IRON FIT Gym. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
